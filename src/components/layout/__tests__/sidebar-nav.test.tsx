...
describe("SidebarNav", () => {
  ...
  it("uses separate disclosure buttons for collapsible rows", async () => {
    ...
    const sphereToggle = screen.getAllByRole("button", {
      name: "Expand or collapse: Sphere 1",
    })[0];
    ...
    const goalToggle = screen.getAllByRole("button", {
      name: "Expand or collapse: Goal 1",
    })[0];
