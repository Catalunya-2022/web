...
export const pressSections: PressSection[] = [
  ...
  },
  {
    ...
    articles: [
      ...
      {
        url: "https://www.vilaweb.cat/noticies/el-govern-crea-el-grup-catalunya-2022-per-dissenyar-la-sortida-a-la-crisi-del-coronavirus/",
        outlet: "VilaWeb",
        domain: "vilaweb.cat",
        title:
          "El govern crea el grup Catalunya 2022 per dissenyar la sortida de la crisi del coronavirus",
        date: "2020-06-02",
        highlighted: false,
      },
      {
        url: "https://www.3cat.cat/324/una-trentena-dexperts-dissenyaran-com-ha-de-ser-la-catalunya-post-covid/noticia/3019064/",
        outlet: "324",
        domain: "3cat.cat",
        title:
          "Una trentena d'experts dissenyaran com ha de ser la Catalunya post-Covid",
        date: "2020-06-02",
        highlighted: false,
      },
      {
        url: "https://www.elnacional.cat/ca/politica/coronavirus-30-experts-govern-catalunya-estrategia-2020_509475_102.html",
        outlet: "El Nacional",
        domain: "elnacional.cat",
        title:
          "Els 30 experts que el Govern ha mobilitzat per fer l'estratègia post-coronavirus",
        date: "2020-06-02",
        highlighted: false,
      },
      {
        url: "https://www.viaempresa.cat/empresa/genis-roca-liderara-catalunya-2022-grup-experts-superar-crisi-covid_2125817_102.html",
        outlet: "Via Empresa",
        domain: "viaempresa.cat",
        title:
          "Genís Roca liderarà Catalunya 2022, grup d'experts per superar la crisi per la COVID",
        date: "2020-06-02",
        highlighted: false,
      },
      {
