...
export function buildAlternates(
  ...
  options: { markdownAlternate?: boolean } = {}
  ...
  return {
    ...
    // llms.txt v2 link relation pointing agents at the page's markdown mirror
    // (generated into public/ by scripts/generate-document-markdown.ts).
    ...(options.markdownAlternate && {
      types: { "text/markdown": `${buildAbsoluteUrl(slug, currentLocale)}.md` },
    }),
  };
}
