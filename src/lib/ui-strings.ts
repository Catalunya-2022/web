...
type UiStrings = {
  ...
  peopleConsultedMetaDescription: string;
...
export const uiStrings: Record<Locale, UiStrings> = {
  ca: {
    ...
    peopleConsultedMetaDescription:
      "El Grup de Treball Catalunya 2022 va dialogar amb centenars de persones i una crida oberta va recollir més de 1.400 propostes de més de 500 col·laboradors.",
    ...
    expandCollapse: "Desplega o replega",
    ...
    organizationsMetaDescription:
      "Més de 220 organitzacions de tots els sectors de Catalunya van contribuir amb propostes als 12 objectius i 91 accions del document.",
  ...
  en: {
    ...
    peopleConsultedMetaDescription:
      "The 2022 Catalonia Task Force engaged hundreds of people in dialogue, and an open call gathered more than 1,400 proposals from over 500 contributors.",
    ...
    organizationsMetaDescription:
      "Over 220 organizations from all sectors of Catalonia contributed proposals to the 12 goals and 91 actions of the document.",
    pressMetaDescription:
  ...
  es: {
    ...
    taskForceDescription:
      "El 2 de junio de 2020, el Gobierno de la Generalitat de Catalunya creó el Grupo de Trabajo Catalunya 2022, un organismo independiente de 30 expertos de la sociedad civil, coordinado por Victòria Alsina y Genís Roca. Trabajando de manera voluntaria, sus miembros definieron políticas para asegurar la competitividad y el desarrollo de Cataluña tras la Covid-19. Dialogaron con centenares de personas y organizaciones, recibieron más de 1.400 propuestas del público y entregaron 12 objetivos y 91 acciones concretas al nuevo Gobierno de la Generalitat.",
    organizationsSubtitle: "Más de 220 organizaciones de la sociedad civil",
    organizationsTitle: "Organizaciones Consultadas",
    organizationsDescription:
      "El grupo de trabajo envió cartas a más de 400 entidades (administraciones, partidos políticos, empresas, agentes sociales y económicos, organizaciones culturales, universidades y fundaciones) de todos los sectores y territorios de Cataluña, invitándolas a compartir propuestas de recuperación y reflexiones estratégicas. Más de 220 organizaciones respondieron, contribuyendo a los 12 objetivos y 91 acciones que forman este documento. El listado siguiente es no exhaustivo y por orden alfabético.",
    ...
    peopleConsultedMetaDescription:
      "El Grupo de Trabajo Catalunya 2022 dialogó con centenares de personas y una convocatoria abierta recogió más de 1.400 propuestas de más de 500 colaboradores.",
    ...
    siteDescription: "Un plan estratégico para reactivar Cataluña, creado por el Grupo de Trabajo Catalunya 2022",
    ...
    close: "Cerrar",
    toggleSidebar: "Alternar barra lateral",
    expandCollapse: "Despliega o repliega",
    ...
    organizationsMetaDescription:
      "Más de 220 organizaciones de todos los sectores de Cataluña contribuyeron con propuestas a los 12 objetivos y 91 acciones del documento.",
    pressMetaDescription:
