...
[![DOI](https://img.shields.io/badge/DOI-10.5281%2Fzenodo.19500831-blue)](https://doi.org/10.5281/zenodo.19500831)
...
- [Next.js 16](https://nextjs.org): App Router, React 19, generació estàtica (441 pàgines)
...
| Script | Funció |
|---|---|
| `generate:documents` | Markdown del document (`public/documents/`, versionat) i miralls `.md` per pàgina |
...
A diferència de la resta de sortides generades, els fitxers de `public/documents/` es versionen: si canvies contingut MDX, executa `npm run build` (o `npm run generate:documents`) i inclou-los al commit. La CI falla si queden endarrerits.
