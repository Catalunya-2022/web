...
On 2 June 2020, the Executive Council of the Government of Catalonia approved [resolution GOV/69/2020](https://dogc.gencat.cat/ca/document-del-dogc/index.html?documentId=874219), setting up the [2022 Catalonia Task Force](https://2022.cat/en/task-force), a collegiate body that advises the president of the Government of Catalonia and the Executive Council with the aim of pooling talent from a broad range of spheres and disciplines and benefitting from a commitment from civil society to define policies aimed at assuring the competitiveness and development of Catalonia amid the future circumstances that may arise as a result of Covid-19.

The 2022 Catalonia Task Force has been coordinated by [Victòria Alsina-Burgués](https://2022.cat/en/task-force/victoria-alsina) and [Genís Roca Verard](https://2022.cat/en/task-force/genis-roca), and is formed by the following members: [Joan Abellà Barril](https://2022.cat/en/task-force/joan-abella), [Jordi Amat Fusté](https://2022.cat/en/task-force/jordi-amat), [Oriol Amat i Salas](https://2022.cat/en/task-force/oriol-amat), [Josep Maria Benet Ferran](https://2022.cat/en/task-force/tatxo-benet), [Elisenda Bou-Balust](https://2022.cat/en/task-force/elisenda-bou), [Elies Campo i Cid](https://2022.cat/en/task-force/elies-campo), [Mònica Campos Estévez](https://2022.cat/en/task-force/monica-campos), [Albert Cañigueral Bagó](https://2022.cat/en/task-force/albert-canigueral), [Mercè Crosas i Navarro](https://2022.cat/en/task-force/merce-crosas), [José Antonio Donaire Benito](https://2022.cat/en/task-force/jose-antonio-donaire), [Martina Font Olivé](https://2022.cat/en/task-force/martina-font), [Anna Garriga Ripoll](https://2022.cat/en/task-force/anna-garriga), [Gabriel Jené Llabrés](https://2022.cat/en/task-force/gabriel-jene), [Jacint Jordana Casajuana](https://2022.cat/en/task-force/jacint-jordana), [Josep Maria Martorell Rodon](https://2022.cat/en/task-force/josep-maria-martorell), [Ramon Maspons Bosch](https://2022.cat/en/task-force/ramon-maspons), [Neus Monllor Rico](https://2022.cat/en/task-force/neus-monllor), [Cristina Nadal Sanmartín](https://2022.cat/en/task-force/cristina-nadal), [Laura Peracaula Basagaña](https://2022.cat/en/task-force/laura-peracaula), [Mercedes Pujol Artigas](https://2022.cat/en/task-force/merce-pujol), [Coral Regí Rodríguez](https://2022.cat/en/task-force/coral-regi), [Josep Maria Salas i Prat](https://2022.cat/en/task-force/pep-salas), [Jordi Sellas i Ferrés](https://2022.cat/en/task-force/jordi-sellas), [Maria Sisternas Tusell](https://2022.cat/en/task-force/maria-sisternas), [Montse Solsona Pairó](https://2022.cat/en/task-force/montserrat-solsona), [Lluís Torner Sabata](https://2022.cat/en/task-force/lluis-torner), [Laura Urquizu Barasoain](https://2022.cat/en/task-force/laura-urquizu) and [Montserrat Vendrell Rius](https://2022.cat/en/task-force/montserrat-vendrell). It is attached to the Ministry of the Presidency and has benefitted from the support of the Directorate-General for Analysis and Foresight.
...
History tells us that whenever the world has embraced processes of transformation, Catalonia has joined in resolutely thanks to the drive of civil society, which has explored the future both from the standpoint of the economy and the business world, and from the perspective of science and the arts. The construction of Urgell canal or the first railway line in Spain is contemporaneous to the cultural movement of the Catalan Renaissance (approx. 1830s-1880s) or the appearance of the popular athenaeums. Based on this background, the [2022 Catalonia Task Force](https://2022.cat/en/task-force) offers a reflection from the arena of civil society in order to tackle the current health crisis that coincides with a period of structural change shifting towards a digital society. Far from serving as a compulsory compendium, this paper strives to act as a motivation for debate, reflection and, hopefully, decision-making.

The 2022 Catalonia Task Force has organised its proposals into three spheres: [society](https://2022.cat/en/sphere-1), [economy](https://2022.cat/en/sphere-2) and [administration](https://2022.cat/en/sphere-3). It considers that the current context calls for emphasis on support, care and growth for people; development of the economy and the competitiveness of Catalonia; and modernisation of the administration to transform it into an efficient driver operating as part of a network geared to generating public value. A concept of a nation where people are at the heart of policy.

In order to achieve [a fair, empowered and capable society](https://2022.cat/en/sphere-1), we view education and culture as the primary driving forces behind personal, collective and nationwide transformations. These spheres act as the gateway to rights and critical spirit, and it is necessary to focus efforts on [speeding up the transformation of the education system](https://2022.cat/en/sphere-1/goal-2) and on a [cultural policy centred on the development of people](https://2022.cat/en/sphere-1/goal-1), rather than solely on the growth of industries and facilities. It is necessary [to coordinate local culture settings](https://2022.cat/en/sphere-1/goal-1/action-1-5), along with national centres as well, and to be able to assess the extent to which society benefits from the whole cultural system. We need to strive for innovation in terms of content, formats and distribution channels, and tackle the challenges of the audiovisual and digital sectors, [re-establishing the public media](https://2022.cat/en/sphere-1/goal-1/action-1-4). In doing so, it is necessary to bear in mind that in this increasingly globalised and digitalised world, we face a huge challenge in [championing the language](https://2022.cat/en/sphere-1/goal-1/action-1-3) and the future of our cultural identity. Culture and education go hand in hand; accordingly, we also need specific actions [to address school failure and dropout](https://2022.cat/en/sphere-1/goal-2/action-2-4) and [to broaden the independence of schools](https://2022.cat/en/sphere-1/goal-2/action-2-2) in parallel, whilst strengthening education networks in each area and organising various solutions which enable [lifelong learning](https://2022.cat/en/sphere-1/goal-2/action-2-6) processes, which must also encompass vocational training.

The great majority of the actions set out in this document strive to solve [structural problems](https://2022.cat/en/sphere-3/goal-11/action-11-5) that the pandemic has simply revealed or magnified. The health crisis has triggered dangers in terms of health, employment, housing and future prospects, further highlighting the need to progress towards a more effective and proactive [comprehensive care and support model](https://2022.cat/en/sphere-1/goal-3). It is vital to [connect health and social services](https://2022.cat/en/sphere-1/goal-3/action-3-1), overcoming the stigmatisation that ties social services solely to persons in extreme situations, and making these services universal to enable everybody to benefit from an assigned social and medical professional to support them with their vital development, incorporating a holistic, empowering perspective of the relationship between the individual and the community. It is necessary [to improve the conditions for people working in domestic roles and caring for dependents](https://2022.cat/en/sphere-1/goal-3/action-3-6), to showcase the economic value of this whole activity and to regulate professions in this sector. Our proposal is to enable access to [housing as a critical mechanism to combat structural inequalities](https://2022.cat/en/sphere-1/goal-4) through a determined intervention to bring 10% of housing under public ownership within ten years.

The competitiveness of our economy will depend on talent and innovation. We need to be highly active in [enhancing and upgrading our tax and regulatory system](https://2022.cat/en/sphere-2/goal-5) so that it can finally help to deliver the changes we wish to encourage as a nation, such as the construction of competitive benefits by applying the [circular economy](https://2022.cat/en/sphere-2/goal-5/action-5-6) or, more specifically, the incorporation of [green innovation into the traditional industrial fabric](https://2022.cat/en/sphere-2/goal-5/action-5-5). We propose specific actions to [champion local trade](https://2022.cat/en/sphere-3/goal-11) using familiar mechanisms (such as urban economic promotion areas) or new ones (such as the set-up of urban logistics hubs), as well as specific actions for tourism, such as [redirecting the tax on stays in tourism establishments](https://2022.cat/en/sphere-2/goal-5/action-5-10) or [bringing our tourist marketing up to date](https://2022.cat/en/sphere-2/goal-5/action-5-11), both with regard to the governance model and in terms of uses of technology.

Aside from the already familiar need to achieve greater sovereignty in the management of our key infrastructure, we also sought to highlight our similarly necessary [food and energy sovereignty](https://2022.cat/en/sphere-2/goal-6). A resolute commitment to [zero-mile energy](https://2022.cat/en/sphere-2/goal-6/action-6-1) is needed on a municipal level and with regard to family housing, whilst encouraging the [purchase of local, green produce](https://2022.cat/en/sphere-2/goal-6/action-6-5) by lending [support to fishing, forestry, livestock and agricultural sites](https://2022.cat/en/sphere-2/goal-6/action-6-10) to improve their management, to ensure they are environmentally friendly and to enable technology to be applied to their exchanges and markets in order to ensure fairer pricing, reduced costs and enhanced competitiveness.

Scientific research is a driving force for development and we must insist on [training, attraction and retention of talent](https://2022.cat/en/sphere-2/goal-7/action-7-3), as well as on [knowledge and technology transfer](https://2022.cat/en/sphere-2/goal-7). We should provide ourselves with tax incentive programmes, investment funds and public procurement models to [champion projects generated within the enterprising ecosystem of Catalonia](https://2022.cat/en/sphere-2/goal-7), both those based on disruptive technologies and those that are already at the incubation stage. We require a [Catalonia founded on science and data](https://2022.cat/en/sphere-2/goal-8) where decisions concerning health, economy, administrative and service-related organisation throughout Catalonia, education and the rights and obligations of citizens, among other aspects, are forged on a foundation of scientific knowledge and empirical evidence-based facts. It is essential to benefit from a [real-time system of data broken down by regions](https://2022.cat/en/sphere-3/goal-11/action-11-2) to support decision-making both by citizens and by the public and private sectors.

The activation of Catalonia put forward in this document calls for an [administration centred on creating public value](https://2022.cat/en/sphere-3/goal-10), fostering and encouraging the participation of civil society; that is, a mobilising administration that serves as a catalyst for change and that brings itself into the modern world in order to be able to organise a [public/private cooperation](https://2022.cat/en/sphere-3/goal-10/action-10-5) model to channel the commitment of civil society (companies, associations, citizens) to the development of Catalonia and the wellbeing of the people. We need [new staff promotion and selection systems within the administration](https://2022.cat/en/sphere-3/goal-9), we must foster regulations to prevent job insecurity and [turn public management into a professional activity](https://2022.cat/en/sphere-3/goal-9/action-9-3) starting with directorate generals. We should also foster [horizontal careers and mobility of public workers](https://2022.cat/en/sphere-3/goal-9/action-9-5) between various administrations and organisations in the public sector to the extent that, for instance, one individual may spend a number of days working for the Government of Catalonia with the remainder of the week spent at a town council. We propose establishing mechanisms to [assess the activity of the administration according to the public value generated](https://2022.cat/en/sphere-3/goal-10) (and not merely based on meeting deadlines and conditions) while re-designing processes, encouraging the [independence of public sector bodies](https://2022.cat/en/sphere-3/goal-10/action-10-4) and promoting citizen audits.

Rebalancing the organisation of the different Catalan regions calls for the implementation of [new local administration funding systems](https://2022.cat/en/sphere-3/goal-11), the [coordination of regional plans](https://2022.cat/en/sphere-3/goal-11/action-11-3) and a special plan for microtowns, but it also requires a major forestry pact to promote the [green economy](https://2022.cat/en/sphere-3/goal-11/action-11-6) and a [blue pact](https://2022.cat/en/sphere-3/goal-11/action-11-7) to preserve and develop the Catalan coastline. This regional situation also involves [assuring first-class connectivity throughout Catalonia](https://2022.cat/en/sphere-3/goal-12) and [eradicating digital poverty](https://2022.cat/en/sphere-3/goal-12/action-12-5) in order [to raise Catalonia into the Cloud](https://2022.cat/en/sphere-3/goal-12). We need a [cross-departmental personal data architecture](https://2022.cat/en/sphere-3/goal-12/action-12-2) that encompasses the various administrations, adopting the [once-only principle](https://2022.cat/en/sphere-3/goal-12/action-12-1) to any procedure, along with a legal [act to govern the digital public sector](https://2022.cat/en/sphere-3/goal-12/action-12-4) that will unlock the current legal barriers that are standing in the way of implementing the digital services characteristic of a modern society.

In total, [twelve goals organised into three spheres and broken down into 91 actions](https://2022.cat/en/action-plan) to reactivate Catalonia. This is a proposal to start a Catalonia-wide debate centred on action.
